...
#Region "Summary Global Table"
    Public Sub allcompany1()
        ...
        acomp = New DataTable
        acomp = dv.ToTable()
        acomp.Columns.Add("deltaRs", GetType(Integer))
    ...
    Public Sub Init_Gtbl_Summary_Analysis_ExpiryWise()
        ...
        With Gtbl_Summary_Analysis_ExpiryWise.Columns
            ...
            .Add("gamma", GetType(Integer))
            .Add("vega", GetType(Integer))
            .Add("theta", GetType(Integer))
            .Add("volga", GetType(Integer))
            .Add("vanna", GetType(Double))
            .Add("grossMTM", GetType(Integer))
            .Add("deltaRS", GetType(Integer))
