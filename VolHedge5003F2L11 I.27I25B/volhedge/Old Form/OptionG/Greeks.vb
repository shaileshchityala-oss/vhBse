...
Namespace OptionG
    ...
    Public Class Greeks
        ...
        Public Shared Function Vol(ByVal futval As Double, ByVal stkprice As Double, ByVal cpprice As Double, ByVal _mt As Double, Mrateofinterast As Double, ByVal mIsCall As Boolean, ByVal mIsFut As Boolean) As Double
