...
Public Class CNseImportContractZip
    ...
    Sub New()
        ...
        Dim fileName As String = "contract.zip"
        mContext.mDownIDKey = "NseFOZip"
    ...
    Public Function PostProcess() As Boolean
        ...
        If File.Exists(mContext.mDownloadedFilePath) Then
            'UnZip1(mContext.mDownloadedFilePath, mContext.mDownloadFolder, 4096)
            'CZip.ZipExtract(mContext.mDownloadedFilePath, mContext.mDownloadFolder)
            CZip.ExtractZipWithOverwrite(mContext.mDownloadedFilePath, mContext.mDownloadFolder)
            mLabel.Text = "Extract Done."

            Dim contractFile As String = mContext.mDownloadFolder + "\contract.txt"
