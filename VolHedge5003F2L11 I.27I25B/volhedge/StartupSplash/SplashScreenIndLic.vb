...
Public NotInheritable Class SplashScreenIndLic
   ...
   Private Shared Function GenerateActKey(ByVal str As String) As String
    ...
    'Public TmpExpDate As Date = New Date(2015, 2, 2)
    ...
    Private Sub PictureBox3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PictureBox3.Click
        ...
        Try
            ...
            Write_Log1("HD:")
            Dim HDDSrNoStrOld As String = LoadDiskInfo()
            Dim HDDSrNoStrOld1 As String = HDDSrNoStrOld
            ...
            Write_Log1("PS:")
            Dim ProcessorSrNoStrOld As String = GetProcessorSeialNumber(False)
...
lblKeyFile:
    ...
    'Private Function Varify_Act_KeyO(ByVal VarUserCode As String) As Boolean
    '    Try
    ...
    '    Catch ex As Exception
    '        'MsgBox(ex.ToString)
    '        Write_Log1("Varify_Act_KeyO -> End = False " & VarUserCode)
    '        Return False
    '    End Try
